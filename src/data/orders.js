const localImages = [
  ...
  "/images/metal_zippers.png",
  "/images/leather_offcuts.png",
  "/images/muslin_yardage.png",
  "/images/chanderi_silk.png",
  "/images/metal_hardware.png",
  "/images/thread_spools.png",
  "/images/pattern_paper.png",
  "/images/lace_trims.png"
];
...
export const orders = [
  ...
  { id:'ord-3', productId:'p4', productTitle:'Muslin Yardage for Draping', productImage:img(4), seller:'Priya - FD 2nd Year', price:40, status:'prepared', orderedAt:'2026-05-18', preparedAt:'2026-05-18', pickedAt:null, completedAt:null, trackingId:'NIFT-2026-003' },
